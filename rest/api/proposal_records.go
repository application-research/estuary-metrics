...
func configGinProposalRecordsRouter(router gin.IRoutes) {
	router.GET("/proposalrecords", ConverHttpRouterToGin(GetAllProposalRecords))
	router.POST("/proposalrecords", ConverHttpRouterToGin(AddProposalRecords))
	router.GET("/proposalrecords/:argPropCid", ConverHttpRouterToGin(GetProposalRecords))
	router.PUT("/proposalrecords/:argPropCid", ConverHttpRouterToGin(UpdateProposalRecords))
	router.DELETE("/proposalrecords/:argPropCid", ConverHttpRouterToGin(DeleteProposalRecords))
}
...
func GetAllProposalRecords(w http.ResponseWriter, r *http.Request, ps httprouter.Params) {
	...
	if err := ValidateRequest(ctx, r, "proposal_records", model.RetrieveMany); err != nil {
...
func GetProposalRecords(w http.ResponseWriter, r *http.Request, ps httprouter.Params) {
	...
	if err := ValidateRequest(ctx, r, "proposal_records", model.RetrieveOne); err != nil {
		returnError(ctx, w, r, err)
		return
	}
...
func AddProposalRecords(w http.ResponseWriter, r *http.Request, ps httprouter.Params) {
	...
	if err := readJSON(r, proposalrecords); err != nil {
		returnError(ctx, w, r, dao.ErrBadParams)
		return
	}
	...
	if err := ValidateRequest(ctx, r, "proposal_records", model.Create); err != nil {
		returnError(ctx, w, r, err)
		return
	}
	...
	writeJSON(ctx, w, proposalrecords)
}
...
func UpdateProposalRecords(w http.ResponseWriter, r *http.Request, ps httprouter.Params) {
	...
	if err := ValidateRequest(ctx, r, "proposal_records", model.Update); err != nil {
		returnError(ctx, w, r, err)
		return
	}
...
func DeleteProposalRecords(w http.ResponseWriter, r *http.Request, ps httprouter.Params) {
	...
	if err := ValidateRequest(ctx, r, "proposal_records", model.Delete); err != nil {
		returnError(ctx, w, r, err)
		return
	}
