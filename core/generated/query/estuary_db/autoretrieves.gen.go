...
func newAutoretrieve(db *gorm.DB) autoretrieve {
	...
	_autoretrieve.LastAdvertisement = field.NewTime(tableName, "last_advertisement")
	_autoretrieve.PubKey = field.NewString(tableName, "pub_key")
...
func (a *autoretrieve) updateTableName(table string) *autoretrieve {
	...
	a.LastAdvertisement = field.NewTime(table, "last_advertisement")
	a.PubKey = field.NewString(table, "pub_key")
...
func (a *autoretrieve) fillFieldMap() {
	...
	a.fieldMap["last_advertisement"] = a.LastAdvertisement
	a.fieldMap["pub_key"] = a.PubKey
